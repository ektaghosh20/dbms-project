...
def paymentwin():
    ...
    pay_frame = customtkinter.CTkFrame(master=app, width=600, height=270, fg_color="blue",
                                          border_width=10,
                                          border_color="black")  # ,border_width=2,border_color="black"
    pay_frame.pack(padx=0, pady=0)
    ...
    paylabel.pack(padx=0, pady=20)

    blanklabel = customtkinter.CTkLabel(master=pay_frame, text="", fg_color='transparent',
                                        height=0)  # width = 1000,,corner_radius=25,fg_color='darkblue',font=("Comfortaa",30)
    blanklabel.pack(padx=0, pady=0)
...
def mapwin():
    ...
    detail_frame = customtkinter.CTkFrame(master=app, width=1000, height=1200, fg_color="#272f32", border_width=10,
                                          border_color="black")  # ,border_width=2,border_color="black"
    detail_frame.pack(padx=50, pady=0, side = tk.LEFT)
    detail_frame.pack_propagate(True) #to make sure it doesn't get resized

    data_frame = customtkinter.CTkFrame(master=app, width=1080, height=1200, fg_color="#272f32", border_width=10,
                                          border_color="black")  # ,border_width=2,border_color="black"
    data_frame.pack(padx=0, pady=0, side=tk.LEFT)
    data_frame.pack_propagate(True)  # to make sure it doesn't get resized
    ...
    price_lbl.grid(row=9, column=1, padx=10, pady=10)
...
def createnew():
    ...
    signin_frame = customtkinter.CTkFrame(master=app, width=1080, height=1070, fg_color="transparent", border_width=10,
                                          border_color="black")  # ,border_width=2,border_color="black"
    signin_frame.pack(padx=20, pady=50)
...
blanklabel = customtkinter.CTkLabel(master=signin_frame,text = "",fg_color='transparent',height=0) #width = 1000,,corner_radius=25,fg_color='darkblue',font=("Comfortaa",30)
blanklabel.pack(padx=0,pady=0)
...
loginbutton.pack(padx=0, pady=10)

createnewbutton = customtkinter.CTkButton(master=signin_frame, text="Create New",text_color="black",width=200,height=50,border_width=0,corner_radius=8,
                                          fg_color="#8bbad0",hover_color="#3d525c",font=("Comfortaa",18,"bold"),command=createnew)
createnewbutton.pack(padx=0, pady=8)
